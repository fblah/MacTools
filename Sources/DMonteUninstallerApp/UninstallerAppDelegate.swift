...
private final class UninstallerStatusView: NSControl {
    ...
    init() {
        image = NSImage(systemSymbolName: "trash", accessibilityDescription: "Uninstall Apps") ?? NSImage()
...
final class UninstallerAppDelegate: NSObject, NSApplicationDelegate, NSWindowDelegate {
    ...
    private func configureStatusItem() {
        let item = NSStatusBar.system.statusItem(withLength: UninstallerStatusView.statusWidth)
        statusItem = item

        let statusView = UninstallerStatusView()
