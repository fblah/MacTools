...
public enum ToolboxCatalog {
    ...
    public static let all: [ToolboxTool] = [
        ...
        ToolboxTool(id: "audioRouter", title: "Audio Router", iconName: "point.3.connected.trianglepath.dotted", tint: .indigo, bundleID: prefix + "audiorouter", appName: "DMonte Audio Router.app", executableName: "DMonteAudioRouter", arguments: ["--open"]),
