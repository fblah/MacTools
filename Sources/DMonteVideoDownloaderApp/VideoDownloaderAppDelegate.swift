...
final class VideoDownloaderAppDelegate: NSObject, NSApplicationDelegate, NSWindowDelegate {
    ...
    private func configureStatusItem() {
        ...
        let icon = NSImage(systemSymbolName: "play.rectangle.fill", accessibilityDescription: "Download Video") ?? NSImage()
        StatusBarButtonContent.install(image: icon, in: item, toolTip: "Download Video", target: self, action: #selector(statusItemClicked))
    }
