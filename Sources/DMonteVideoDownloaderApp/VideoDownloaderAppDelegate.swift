...
private final class VideoDownloaderStatusView: NSControl {
    ...
    init() {
        image = NSImage(systemSymbolName: "play.rectangle.fill", accessibilityDescription: "Download Video") ?? NSImage()
...
final class VideoDownloaderAppDelegate: NSObject, NSApplicationDelegate, NSWindowDelegate {
    ...
    private func configureStatusItem() {
        let item = NSStatusBar.system.statusItem(withLength: VideoDownloaderStatusView.statusWidth)
        statusItem = item

        let statusView = VideoDownloaderStatusView()
