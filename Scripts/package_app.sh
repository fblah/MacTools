...
rm -rf "$APP_DIR"
mkdir -p "$MACOS_DIR" "$FRAMEWORKS_DIR" "$SYSTEM_MONITOR_MACOS_DIR" "$UNINSTALLER_MACOS_DIR" "$CLEAN_DRIVE_MACOS_DIR" "$VIDEO_DOWNLOADER_MACOS_DIR" "$VIDEO_DOWNLOADER_BIN_DIR"
